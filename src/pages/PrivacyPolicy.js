  ...
  return (
    <section>
      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-8 py-24 text-base leading-7 text-gray-700">
        <div>
          <h2 className="text-gray-500">10.10.2023</h2>
          <h1 className="text-3xl mb-3 font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl">Privacy Policy</h1>
        </div>
        <div>
        ...
        <div className="mt-5 text-gray-900 lg:max-w-none">
          <p className="mb-3">
          ...
          <p className="mb-3">
            Bibendum eu nulla feugiat justo, elit adipiscing. Ut tristique sit nisi lorem pulvinar. Urna, laoreet fusce
            nibh leo. Dictum et et et sit. Faucibus sed non gravida lectus dignissim imperdiet a.
          </p>
          <p className="mb-3">
          ...
          <p className="mb-3">
            ...
            faucibus semper. Pellentesque in venenatis vestibulum consectetur nibh id. In id ut tempus egestas. Enim sit
            aliquam nec, a. Morbi enim fermentum lacus in. Viverra.
          </p>
          <h3 className="font-bold">Tincidunt integer commodo</h3>
          <p className="mb-3">
